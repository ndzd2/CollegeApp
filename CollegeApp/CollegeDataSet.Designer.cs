            ...
            public string name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'name\' w tabeli \'student\' to DBNull.", e);
                    }
                }
                set {
...
namespace CollegeApp.CollegeDataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CollegeApp.Properties.Settings.Default.CollegeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT DISTINCT student.id, student.name
...
WHERE        (student.semester_no = 1) AND (subject.name = 'C# Programming')";
